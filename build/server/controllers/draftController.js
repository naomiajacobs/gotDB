...
var startDraft = function startDraft(req, res) {
  ...
  return League.findOne({
    ...
    // grab charids
    return Character.findAll({ attributes: ['id'] }).then(function (characters) {
...
var submitDraft = function submitDraft(req, res) {
  ...
  return RosterData.bulkCreate(rosterDataObjects).then(function (resp) {
