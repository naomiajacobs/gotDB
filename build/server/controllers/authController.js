...
var signup = function signup(req, res, next) {
  ...
  User.findOne({ where: { username: username } }).then(function (user) {
    ...
    return makeRoster(user).then(function (roster) {
      return Character.findAll().then(function (characters) {
        ...
        return Character.findAll().then(function (characters) {
          return Event.findAll().then(function (events) {
            ...
            if (!user.dataValues.league) {
              ...
              return makeRosters(user.dataValues.league.users, user.dataValues.league.latestSeen).then(function (rosters) {
